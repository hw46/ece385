...
#
# Script generated by Vivado on Fri Jul 26 05:10:17 +0800 2024
...
#
# Usage        : mb_block.sh
#                mb_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mb_block.sh [-reset_run]
#                mb_block.sh [-reset_log]
#                mb_block.sh [-help]
#
...
#                script (type 'mb_block.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname microblaze_v11_0_13 -libname xil_defaultlib -libname lmb_v10_v3_0_14 -libname lmb_bram_if_cntlr_v4_0_24 -libname blk_mem_gen_v8_4_8 -libname generic_baseblocks_v2_1_2 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_31 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_crossbar_v2_1_32 -libname axi_lite_ipif_v3_0_4 -libname axi_intc_v4_1_19 -libname mdm_v3_2_26 -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname lib_pkg_v1_0_4 -libname lib_srl_fifo_v1_0_4 -libname axi_uartlite_v2_0_35 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm microblaze_v11_0_13 xil_defaultlib lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_24 blk_mem_gen_v8_4_8 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_crossbar_v2_1_32 axi_lite_ipif_v3_0_4 axi_intc_v4_1_19 mdm_v3_2_26 lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 lib_pkg_v1_0_4 lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_35)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mb_block.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mb_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  "../../../bd/mb_block/ip/mb_block_lmb_bram_0/sim/mb_block_lmb_bram_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  "../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  "../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  "../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  "../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_32 $xmvlog_opts +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ipshared/3242" +incdir+"../../../../Soc_graphics.gen/sources_1/bd/mb_block/ip/mb_block_hdmi_text_controller_0_0/src/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mb_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mb_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mb_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: mb_block.sh [-step]\n\
Usage: mb_block.sh [-lib_map_path]\n\
Usage: mb_block.sh [-reset_run]\n\
Usage: mb_block.sh [-reset_log]\n\
Usage: mb_block.sh [-keep_index]\n\
